...
def vehicle_double_track_model(dX_prev, X, pedal_req, delta_req, pacejka_data, vehicle_data):
    ...
    # First order slip dynamics: slip and forces not generated instantaneously (8 states)
    ...
    izz    = vehicle_data.vehicle.i_zz #rotating inertia of the vehicle
    ...
    Vlow = vehicle_data.vehicle.Vlow_long # flag to low level velocity to modify the equation
