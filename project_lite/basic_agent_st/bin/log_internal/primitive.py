...
for i in range(1,len(c1),10):
    dati_matrice1 = matrice_space[i, :]
    dati_matrice2 = matrice_speed[i, :]
    plt.plot(dati_matrice1, dati_matrice2, label='Longitudinal velocity primitive', color='green')
plt.show()