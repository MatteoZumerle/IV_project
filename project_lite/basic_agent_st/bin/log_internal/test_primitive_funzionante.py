...
for i in range(0, len(c1), 10):
    for t in range(1, 6):
        valore_space[i, t-1] = (
            c1[i] * (tempo[i] + (t-1) * 0.1) +
            (1/2) * c2[i] * (tempo[i] + (t-1) * 0.1)**2 +
            (1/6) * c3[i] * (tempo[i] + (t-1) * 0.1)**3 +
            (1/24) * c4[i] * (tempo[i] + (t-1) * 0.1)**4 +
            (1/120) * c5[i] * (tempo[i] + (t-1) * 0.1)**5
        )
        valore_speed[i, t-1] = (
            c1[i] +
            c2[i] * (tempo[i] + (t-1) * 0.1) +
            (1/2) * c3[i] * (tempo[i] + (t-1) * 0.1)**2 +
            (1/6) * c4[i] * (tempo[i] + (t-1) * 0.1)**3 +
            (1/24) * c5[i] * (tempo[i] + (t-1) * 0.1)**4
        )

# Plotto le primitive ottenute
for i in range(0, len(c1)-50, 10):
    plt.figure(1)
