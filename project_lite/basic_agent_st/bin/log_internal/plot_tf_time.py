...
#time, dist, vel, acc, Sf, vmin, vmax, tmin, tmax, req_vel, req_acc, T, C0, C1, C2, C3, C4, C5, Fasullo;
...
# Crea il secondo grafico tempo accelerazione
ax3.plot(tempo, c3, label='Jerk', color='orange')
...
plt.savefig('plot_tf_time_space.svg', format='svg')
